...
# --- STAGE 3: Final Card ---
    ...
    # Width 215px (57mm handheld standard)
    width = 215 
    height = 280 + (len(st.session_state.history) * 55)
    ...
    draw.text((16, y), name_txt, fill=(0, 0, 0)) # Bold Simulation
    ...
    # THE GO BACK OPTION
    if st.button("⬅️ Back to Percentages"):
        st.session_state.step = "percentage"
        st.rerun()
